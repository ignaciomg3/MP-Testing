...
class ChromiumDriver(RemoteWebDriver):
    ...
    def __init__(
        ...
        :Args:
         ...
         - service - Service object for handling the browser drivers if you need to pass extra details
    ...
    def set_network_conditions(self, **network_conditions) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.set_network_conditions(
                    offline=False,
    ...
    def set_permissions(self, name: str, value: str) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.set_permissions('clipboard-read', 'denied')
        """
    ...
    def execute_cdp_cmd(self, cmd: str, cmd_args: dict):
        ...
        :Usage:
            ::
                ...
                drivers.execute_cdp_cmd('Network.getResponseBody', {'requestId': requestId})
        :Returns:
