...
class WebDriver(BaseWebDriver):
    ...
    def __init__(
        ...
        """Create a new drivers that will issue commands using the wire
        protocol.
        ...
        :Args:
         ...
         - options - instance of a drivers options.Options class
    ...
    def execute_script(self, script, *args):
        ...
        :Usage:
            ::
                ...
                drivers.execute_script('return document.title;')
        """
    ...
    def execute_async_script(self, script: str, *args):
        ...
        :Usage:
            ::
                ...
                drivers.execute_async_script(script)
        """
        converted_args = list(args)
    ...
    def print_page(self, print_options: Optional[PrintOptions] = None) -> str:
        ...
        The drivers makes a best effort to return a PDF based on the
        provided parameters.
        """
        options = {}
        if print_options:
    ...
    def switch_to(self) -> SwitchTo:
        ...
        :Usage:
            ::
                ...
                element = drivers.switch_to.active_element
                alert = drivers.switch_to.alert
                drivers.switch_to.default_content()
                drivers.switch_to.frame('frame_name')
                drivers.switch_to.frame(1)
                drivers.switch_to.frame(drivers.find_elements(By.TAG_NAME, "iframe")[0])
                drivers.switch_to.parent_frame()
                drivers.switch_to.window('main')
        """
    ...
    def delete_cookie(self, name) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.delete_cookie('my_cookie')
        """
    ...
    def add_cookie(self, cookie_dict) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.add_cookie({'name' : 'foo', 'value' : 'bar'})
                drivers.add_cookie({'name' : 'foo', 'value' : 'bar', 'path' : '/'})
                drivers.add_cookie({'name' : 'foo', 'value' : 'bar', 'path' : '/', 'secure' : True})
                drivers.add_cookie({'name' : 'foo', 'value' : 'bar', 'sameSite' : 'Strict'})
        """
    ...
    def set_page_load_timeout(self, time_to_wait: float) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.set_page_load_timeout(30)
        """
        try:
    ...
    def find_element(self, by=By.ID, value: Optional[str] = None) -> WebElement:
        ...
        :Usage:
            ::
                ...
                element = drivers.find_element(By.ID, 'foo')
    ...
    def find_elements(self, by=By.ID, value: Optional[str] = None) -> List[WebElement]:
        ...
        :Usage:
            ::
                ...
                elements = drivers.find_elements(By.CLASS_NAME, 'foo')
        ...
        # Return empty list if drivers returns null
    ...
    def get_screenshot_as_file(self, filename) -> bool:
        ...
        :Usage:
            ::
                ...
                drivers.get_screenshot_as_file('/Screenshots/foo.png')
        """
    ...
    def save_screenshot(self, filename) -> bool:
        ...
        :Usage:
            ::
                ...
                drivers.save_screenshot('/Screenshots/foo.png')
        """
    ...
    def get_screenshot_as_base64(self) -> str:
        ...
        :Usage:
            ::
                ...
                drivers.get_screenshot_as_base64()
        """
    ...
    def set_window_size(self, width, height, windowHandle: str = "current") -> None:
        ...
        :Usage:
            ::
                ...
                drivers.set_window_size(800,600)
        """
    ...
    def set_window_rect(self, x=None, y=None, width=None, height=None) -> dict:
        ...
        :Usage:
            ::
                ...
                drivers.set_window_rect(x=10, y=10)
                drivers.set_window_rect(width=100, height=200)
                drivers.set_window_rect(x=10, y=10, width=100, height=200)
        """
    ...
    def orientation(self):
        ...
        :Usage:
            ::
                ...
                orientation = drivers.orientation
        """
    ...
    def get_log(self, log_type):
        ...
        :Usage:
            ::
                ...
                drivers.get_log('browser')
                drivers.get_log('drivers')
                drivers.get_log('client')
                drivers.get_log('server')
        """
    ...
    def fedcm(self) -> FedCM:
        ...
        :Usage:
            ::
                ...
                title = drivers.fedcm.title
                subtitle = drivers.fedcm.subtitle
                dialog_type = drivers.fedcm.dialog_type
                accounts = drivers.fedcm.account_list
                drivers.fedcm.select_account(0)
                drivers.fedcm.accept()
                drivers.fedcm.dismiss()
                drivers.fedcm.enable_delay()
                drivers.fedcm.disable_delay()
                drivers.fedcm.reset_cooldown()
        """
        return self._fedcm
