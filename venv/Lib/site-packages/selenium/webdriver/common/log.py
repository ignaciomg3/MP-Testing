    ...
    async def mutation_events(self) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        :Usage:
             ::
               ...
               async with drivers.log.mutation_events() as event:
                    pages.load("dynamic.html")
                    drivers.find_element(By.ID, "reveal").click()
                    WebDriverWait(drivers, 5)\
                        .until(EC.visibility_of(drivers.find_element(By.ID, "revealed")))
    ...
    async def add_js_error_listener(self) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        :Usage:
             ::
                ...
                async with drivers.log.add_js_error_listener() as error:
                    drivers.find_element(By.ID, "throwing-mouseover").click()
                assert bool(error)
    ...
    async def add_listener(self, event_type) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        :Usage:
             ::
                ...
                async with drivers.log.add_listener(Console.log) as messages:
                    drivers.execute_script("console.log('I like cheese')")
