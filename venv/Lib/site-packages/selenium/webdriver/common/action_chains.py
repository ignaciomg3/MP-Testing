...
class ActionChains:
    ...
    ActionChains can be used in a chain pattern::
        ...
        menu = drivers.find_element(By.CSS_SELECTOR, ".nav")
        hidden_submenu = drivers.find_element(By.CSS_SELECTOR, ".nav #submenu1")

        ActionChains(drivers).move_to_element(menu).click(hidden_submenu).perform()
    ...
    def __init__(self, driver: WebDriver, duration: int = 250, devices: list[AnyDevice] | None = None) -> None:
        ...
        :Args:
         - drivers: The WebDriver instance which performs user actions.
    ...
    def key_down(self, value: str, element: WebElement | None = None) -> ActionChains:
        ...
        Example, pressing ctrl+c::
            ...
            ActionChains(drivers).key_down(Keys.CONTROL).send_keys('c').key_up(Keys.CONTROL).perform()
        """
        if element:
            self.click(element)
