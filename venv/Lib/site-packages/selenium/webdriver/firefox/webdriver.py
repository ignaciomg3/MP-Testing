...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(
        ...
        """Creates a new instance of the Firefox drivers. Starts the service and
        then creates new instance of Firefox drivers.

        :Args:
         - options - Instance of ``options.Options``.
         - service - (Optional) service instance for managing the starting and stopping of the drivers.
    ...
    def install_addon(self, path, temporary=False) -> str:
        ...
        :Usage:
            ::
                ...
                drivers.install_addon('/path/to/firebug.xpi')
        """
    ...
    def uninstall_addon(self, identifier) -> None:
        ...
        :Usage:
            ::
                ...
                drivers.uninstall_addon('addon@foo.com')
        """
    ...
    def get_full_page_screenshot_as_file(self, filename) -> bool:
        ...
        :Usage:
            ::
                ...
                drivers.get_full_page_screenshot_as_file('/Screenshots/foo.png')
        """
    ...
    def save_full_page_screenshot(self, filename) -> bool:
        ...
        :Usage:
            ::
                ...
                drivers.save_full_page_screenshot('/Screenshots/foo.png')
        """
    ...
    def get_full_page_screenshot_as_png(self) -> bytes:
        ...
        :Usage:
            ::
                ...
                drivers.get_full_page_screenshot_as_png()
        """
    ...
    def get_full_page_screenshot_as_base64(self) -> str:
        ...
        :Usage:
            ::
                ...
                drivers.get_full_page_screenshot_as_base64()
        """
