...
class WebDriverWait(Generic[D]):
    def __init__(
        ...
        :Args:
         - drivers - Instance of WebDriver (Ie, Firefox, Chrome or Remote) or a WebElement
        ...
        Example::
         ...
         element = WebDriverWait(drivers, 10).until(lambda x: x.find_element(By.ID, "someId")) \n
         is_disappeared = WebDriverWait(drivers, 30, 1, (ElementNotVisibleException)).\\ \n
    ...
    def until(self, method: Callable[[D], Union[Literal[False], T]], message: str = "") -> T:
        """Calls the method provided with the drivers as an argument until the \
