...
class RelativeBy:
    ...
    Example:
        lowest = drivers.find_element(By.ID, "below")

        elements = drivers.find_elements(locate_with(By.CSS_SELECTOR, "p").above(lowest))
    ...
    def to_dict(self) -> Dict:
        """Create a dict that will be passed to the drivers to start searching
        for the element."""
        return {
            "relative": {
                "root": self.root,
