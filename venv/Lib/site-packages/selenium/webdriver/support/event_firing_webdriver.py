    ...
    def __init__(self, driver: WebDriver, event_listener: AbstractEventListener) -> None:
        ...
        ::
            ...
            class MyListener(AbstractEventListener):
                def before_navigate_to(self, url, drivers):
                    print("Before navigate to %s" % url)
                def after_navigate_to(self, url, drivers):
                    print("After navigate to %s" % url)

            drivers = Firefox()
            ef_driver = EventFiringWebDriver(drivers, MyListener())
