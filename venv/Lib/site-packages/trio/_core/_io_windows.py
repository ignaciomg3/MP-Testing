...
# directly to the socket device drivers in the kernel, which is called "AFD".
...
# digging.
#
# Basically: we open a magic file that refers to the AFD drivers, register the
...
def _afd_helper_handle() -> Handle:
    # The "AFD" drivers is exposed at the NT path "\Device\Afd". We're using
